...
import { acceptAnalytics, getAnalyticsConsent, revokeAnalytics } from "./analytics.js";
...
const buttonRowStyle = { display: "flex", flexWrap: "wrap", gap: 10 };
  ...
  return (
    <div role="dialog" aria-label="Cookie settings" style={panelStyle}>
      ...
      <div style={buttonRowStyle}>
        ...
        <button type="button" style={secondaryStyle} onClick={() => { revokeAnalytics(); setChoice("denied"); }}>
          Reject analytics
        </button>
        <button type="button" style={secondaryStyle} onClick={() => setOpen(false)}>
          Close
        </button>
      </div>
    </div>
