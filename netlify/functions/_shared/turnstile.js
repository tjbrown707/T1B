...
// Turnstile tokens expire after five minutes and are single-use. Missing
// configuration, malformed input, Cloudflare rejection, and network failures
// all fail closed before checkout can reserve inventory or save an order.
